...
class quick_links extends WP_Widget
	...
	{
		parent::__construct(false, $name = "Toscanarunner Quick Links", array("description" => "Toscanarunner Quick Links description"));
	}
...
?>
	        ...
	        <div class="accordion-trigger accordion-trigger_nav accordion-trigger_navSolid js-accordion-trigger" data-accordion-trigger-id="customer-service">
	           <?php echo $args['before_title'] . $title . $args['after_title']; ?>
	        </div>
<?php 
		

		echo '<div class="accordion-panel js-accordion-panel" data-accordion-panel-id="customer-service">
            <ul class="footerMenuList">';
				foreach ($urls as $key => $value){
					if($value) {
						echo '<li class="footerMenuList-item">
			                <a href="'.$value.'" class="footerMenuList-item-trigger">'.$quick_title[$key].'</a>
			                </li>';
					}
				}
		echo '</ul> </div>';
